...
import { ChevronRight, Clock, MapPin, Phone, FileText, Users, Heart, GraduationCap, Building, Calculator } from 'lucide-react-native';
...
export default function ServicesScreen() {
  ...
  return (
    <View style={styles.container}>
      <Header title="City Services" subtitle="Book appointments and access government services" />
